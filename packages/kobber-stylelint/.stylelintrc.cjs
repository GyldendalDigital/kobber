...
module.exports = {
  ...
  rules: {
    ...
    "declaration-no-important": [
      true,
      {
        message: "Avoid using !important, as it messes with specificity - what is the root cause for needing it?",
      },
    ],
    ...
    "order/properties-order": [
      [
        ...
        {
          groupName: "borders",
          properties: ["border", "border-top", "border-right", "border-bottom", "border-left", "border-radius"],
        },
        {
          groupName: "paddings",
          properties: [
    ...
    "property-disallowed-list": ["clear", "float", "outline", "user-select", "will-change"],
    "property-no-unknown": [
      true,
      {
    ...
    "selector-max-type": [
      0,
      {
        message: "Avoid using element names in selectors - use semantic class names",
      },
    ],
    ...
    "selector-no-qualifying-type": [
      ...
      {
        ignore: ["attribute"],
        message: "Avoid using element names in selectors - use BEM to make semantic class names",
      },
    ],
    ...
    "csstools/value-no-unknown-custom-properties": [
      true,
      {
        importFrom: ["../../packages/kobber-base/dist/themes/default/tokens.css", "../../apps/docs/styles/globals.css"],
      },
    ],
  },
};
