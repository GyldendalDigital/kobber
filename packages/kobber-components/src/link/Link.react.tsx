...
export const Link = forwardRef<HTMLAnchorElement, Props>((props, ref) => {
  ...
  return (
    <>
      ...
      <LinkTag {...rest} ref={ref} className={[className, ...linkClassNames(rest)].join(" ")} target={target}>
        {children}
        <Icon />
      </LinkTag>
    </>
...
// Hard coded SVGs while we wait for react icons

const externalLinkIcon = (
  <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
    <g clipPath="url(#clip0_258_9)">
      <path
