...
export const MediaModule: Story = {
  render: args => html`
    <kobber-content-wrapper color-variant=${args.colorVariant} type="page">
      <kobber-media-module credit-placement="${args.creditPlacement}" color="${args.color}" color-variant="${args.colorVariant}">
        ...
        <kobber-text-body slot="description" level="p" color="${args.color}" color-variant="${invertColorVariant(args.colorVariant)}" size="small">
