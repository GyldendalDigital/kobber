...
export type BadgeSize = keyof typeof component.badge.container.gap;
...
export const badgeSizes: BadgeSize[] = Object.keys(component.badge.container.gap) as BadgeSize[];
