...
export const Borders = () => (
  ...
  >
    <RichText>
      <h2>Width</h2>
      <Table>
        {Object.entries(tokens.primitives.border.width).map(([key, value], index) => (
          <tr key={index}>
    ...
    <RichText>
      <h2>Radius</h2>
      <p>
        Forslag til regler: Pill brukes kun til klikkbare elementer. 24 brukes hovedsakelig til klikkbare elementer,
        eller elementer der hovedinnholdet er et klikkbart element. 16 og 8 brukes til ikke-klikkbare ting, som
        fremhevede fargeflater o.l.
      </p>
      <Table>
        {Object.entries(tokens.primitives.border.radius).map(([key, value], index) => (
          <tr key={index}>
