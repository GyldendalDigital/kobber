      ...
      <div className="flex flex-col gap-[48px] ">
        <div className="flex flex-col gap-[24px]  w-full md:w-[806px]">
          ...
          <p className="whitespace-pre-wrap text-16 leading-[24px] text-[#532D37]">
            ...
            “Kobber” hvis det er noe du lurer på. Sjansen kan jo være at temaet
            du lurer på er noe som har blitt diskutert tidligere.
            <br />
            <br />
            Ellers vil én designer og utvikler også være tilgjengelig for
            drop-in hver torsdag på “Hjeeelp” i Bing 4.etasje. Så ta med deg
        ...
        <div>
          ...
          <FeatureBoxGrid
            items={["Irén", "Izelin", "Dagfinn", "Kevin", "Karen"].map(
              (navn) => ({
                title: navn,
