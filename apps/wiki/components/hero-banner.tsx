      ...
      <div className="w-full h-full flex-col flex md:flex-row items-center gap-[72px] md:gap-[182px]">
        ...
        <div className="w-full md:max-w-[507px] flex flex-col gap-5 md:gap-10">
          <div className="grid gap-[4px] md:gap-[8px]">
            <h1 className="text-[28px] md:text-[38px] text-aubergine-850">
              Velkommen til Kobber
              <br />
            </h1>
            <h1 className="text-[28px] md:text-[38px] text-karmin-525">Gyldendals designsystem</h1>
          </div>
          <div className="w-[30ch] h-[68px]">
            <span className="text-aubergine-850 text-base leading-normal">
